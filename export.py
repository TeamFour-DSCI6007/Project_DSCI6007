...
def export_tbnet():
    ...
    # config_path = r'DSCI 6007 02 Distributed & Scalable Data Engineering\Project\tb-net-latest\data\steam\config.json'
    ...
    item = Tensor(np.ones((1,)).astype(int))
    rl1 = Tensor(np.ones((1, net_config.per_item_paths)).astype(int))
    ety = Tensor(np.ones((1, net_config.per_item_paths)).astype(int))
    rl2 = Tensor(np.ones((1, net_config.per_item_paths)).astype(int))
    his = Tensor(np.ones((1, net_config.per_item_paths)).astype(int))
